...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3"> 
        <div class="ps-3">
            ...
            class="btn btn-warning"> Download Xlsx </a>  
                </ol>
            </nav>
        </div>
...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3"> 
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <!-- Export button -->
                    <a href="{{ route('export.permissions') }}" class="btn btn-warning">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <!-- Import form -->
            <form id="importForm" action="{{ route('import.permissions') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf

                <div class="form-group col-md-6">
                    <label for="import_file" class="form-label">Select Excel File (xlsx)</label>
                    <input type="file" name="file" class="form-control" id="import_file" accept=".xlsx,.xls" required>
                </div>
            ...
            @if(session('message'))
                <div class="alert alert-{{ session('alert-type') ?? 'success' }} mt-3">
                    {{ session('message') }}
                </div>
            @endif
            @if($errors->any())
