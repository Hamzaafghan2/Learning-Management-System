    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Add Course</h5>
             <form id="myForm" action="{{route('store.course')}}" method="post" enctype="multipart/form-data" class="row g-3">
                @csrf
                ...
                <div class="form-group col-md-3">
                 ...
                 <div class="form-group col-md-12">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="description" class="form-control" id="	input11" placeholder="description..." ></textarea>
                </div>
