    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Edit Coupon</h5>
             <form id="myForm" action="{{route('instructor.update.coupon')}}" method="post" enctype="multipart/form-data" class="row g-3">
                @csrf
              <input type="hidden" name="coupon_id" value="{{ $coupon->id }}">
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    <label for="input2" class="form-label form-group">Coupon Discount </label>
                    <input class="form-control" name="coupon_discount" type="text" value="{{ $coupon->coupon_discount }}" >
                </div> 
                 <div class="form-group col-md-6">
                    <label for="input2" class="form-label form-group">Courses </label>
                ...
                <div class="form-group col-md-6">
                    <label for="input2" class="form-label form-group">Coupon Discount Date</label>
            ...
            <h5 class="mb-4">Add Coupon</h5>
             <form id="myForm" action="{{route('instructor.update.coupon')}}" method="post" enctype="multipart/form-data" class="row g-3">
               ...
               <input type="hidden" name="id" value="{{ $coupon->id }}">
                ...
                <div class="form-group col-md-6">
                    <label for="input2" class="form-label form-group">Course </label>
                    <select name="course_id" class="form-select mb-3" aria-label="Defualt select example" id=""></select>
                </div>
