...
<div class="page-content">
	...
	<h4>Instructor Account is <span class="text-danger">InActive</span></h4>
		<p class="text-danger"><b>plase wait admin will check and approve your Account</b></p>
	@endif
							 ...
							 <tr>
							  ...
							  <td><div class="progress" style="height: 6px;">
									<div class="progress-bar bg-gradient-bloody" role="progressbar" style="width: 40%"></div>
						 					...
						 					@php
     $courses =App\Models\Course::where('instructor_id', $id)
                         ->orderBy('id', 'desc')
                         ->get();
        @endphp
                ...
                @foreach ($courses as $course)
                    <tr>
                       ...
                       @if($course->course_image)
                                <img src="{{ asset($course->course_image) }}" class="product-img-2" width="90">
                            @else
                                <span>No Image</span>
                            @endif
													</td>
