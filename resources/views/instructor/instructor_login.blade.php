	...
	<div class="wrapper">
        ...
        @csrf
          <div class="col-12">
            ...
            <input type="email" id="email" name="email"  class="form-control @error('email') is invalide @enderror" id="inputEmailAddress" placeholder="jhon@example.com">
          ...
          <div class="col-12">
            ...
            <div class="input-group" id="show_hide_password">
              <input type="password"  id="password"  name="password" class="form-control border-end-0 @error('password') is incorrect! @enderror" 
