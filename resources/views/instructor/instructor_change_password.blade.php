				...
				<div class="container">
					<div class="main-body">
						<div class="row">
							...
							<img src="{{(!empty($profileData->photo)) ? url('upload\instructor_images/'.$profileData->photo): url ('upload\instructor_images\no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
							<div class="mt-3">
