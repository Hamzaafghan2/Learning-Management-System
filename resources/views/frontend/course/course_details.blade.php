        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                @endphp  
                   ...
                   @php
            $avg = floor($average ?? 0); // Ensure number 0–5
                     @endphp
              ...
              @for ($i = 1; $i <= 5; $i++)
                ...
                <span class="rating-total pl-1">({{count($reviews)}} ratings)</span>
...
<section class="course-details-area pb-20px">
    ...
    <li><i class="la la-check mr-1 text-black"></i> {{$goal->goal_name}}</li>
                 @endforeach
                   ...
                   <div class="course-overview-card bg-gray p-4 rounded">
                       <h3 class="fs-16 font-weight-semi-bold">Curated for the <a href="for-business.html" class="text-color hover-underline">Easy Learning for Business</a> collection</h3>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                       <h3 class="fs-20 font-weight-semi-bold">Top companies trust Easy Learning</h3>
                       <p class="fs-15 pb-1">Get your team access to Easy Learning  top 5,00+ courses</p>
                        <div class="pb-3">
                        ...
                        <a href="for-business.html" class="btn theme-btn theme-btn-sm">Try Easy Learning for Business</a>
                   </div><!-- end course-overview-card -->
                   <div class="course-overview-card">
...
@endforeach
                ...
                <div class="media media-card">
                    <div class="instructor-img">
                        ...
                        <ul class="generic-list-item pt-3">
                            <li><i class="la la-star mr-2 text-color-3"></i>  <span class="rating-total pl-1">({{count($reviews)}} ratings)</span></li>
                            <li><i class="la la-user mr-2 text-color-3"></i> <span class="student-total pl-2">{{number_format($enrollmentCount)}} students</span></li>
                            <li><i class="la la-comment-o mr-2 text-color-3"></i>33 Reviews</li>
                            <li><i class="la la-play-circle-o mr-2 text-color-3">
                                </i> {{count( $instructorCourse )}} Courses</li>
    ...
    <span class="rating-total d-block">({{count($reviews)}})</span>
...
<div class="review-bars d-flex justify-content-between align-items-center mb-2" style="width: 100%;">

<div class="review-bars__text" style="width: 70px;">
{{ $ratingInfo['rating'] }} Stars
</div>

<div class="review-bars__fill flex-grow-1 mx-2">
...
<div class="review-bars__percent" style="width: 60px; text-align: right;">
{{ number_format($ratingInfo['percent'], 2) }}%
</div>
...
@endif
    ...
    <div class="media
     media-card border-bottom border-bottom-gray pb-4 mb-4">
 ...
 @endguest
    ...
    <div class="buy-course-btn-box">
        ...
        onclick="AddToCart({{ $course->id}},'{{ $course->course_name}}','{{ $course->instructor_id}}','{{ $course->course_name_slug}}')"><i class="la la-shopping-cart fs-18 mr-1"></i> Add to cart</button>
        ...
        <div class="input-group mb-2" id="couponField">
               ...
               <a type="submit" onclick="applyInscoupon()" class="btn theme-btn">Apply Coupon</a>
                        </div>
                    </div>
    </div>
                ...
                <div class="preview-course-incentives">
                    ...
                    <ul class="generic-list-item pb-3">
                        <li><i class="la la-play-circle-o mr-2 text-color">
                    </i>{{$course->duration}} hours on-demand video</li>
                        <li><i class="la la-file mr-2 text-color">
                        </i>{{$course->resources}} articles</li>
                        <li><i class="la la-file-text mr-2 text-color">
                        </i>12 downloadable resources</li>
                    ...
                    <div class="buy-for-team-container pt-4">
                        ...
                        <p class="lh-24 pb-3">Get your team access to 3,000+ top Easy Learning courses anytime, anywhere.</p>
                        <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try Easy Learning for Business</a>
                    </div>
...
<section class="related-course-area bg-gray pt-60px pb-60px">
    <div class="container">
        ...
        @foreach ( $instructorCourse as $inscourse)
              @php
        $amount=$inscourse->selling_price - $course->discount_price;
        ...
        <div class="card card-item">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                   @if ($inscourse->discount_price == NULL)
                             <p class="card-price text-black font-weight-bold">&{{ $inscourse->discount_price}}</p>
                        @else
                            <p class="card-price text-black font-weight-bold">&{{ $inscourse->selling_price}}<span class="before-price font-weight-medium">&{{ $inscourse->discount_price}}</span></p>
                        @endif
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    <div class="cta-btn-box text-right">
                        <a href="become-a-teacher.html" class="btn theme-btn">Tech on Easy Learning <i class="la la-arrow-right icon ml-1"></i> </a>
                    </div>
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
        </div><!-- end container -->
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <p class="pt-1 fs-14 lh-24">Flagged content is reviewed by Easy Learning staff to determine whether it violates Terms of Service or Community Guidelines. If you have a question or technical issue, please contact our
                        ...
                        <div class="form-group">
                            <div class="select-container w-auto">
                                <select class="select-container-select">
                                    ...
                                    <option value="3">Easy Learning Policy Violation</option>
