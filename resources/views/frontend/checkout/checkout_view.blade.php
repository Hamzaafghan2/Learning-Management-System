...
<section class="cart-area section--padding">
    ...
    <div class="payment-tab is-active">
        ...
        <div class="payment-tab-toggle">
            <input id="cashPayment" name="cash_delivery" type="radio" value="handcash" checked>
            <label for="cashPayment">Direct Payment</label>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="btn-box border-top border-top-gray pt-3">
            <p class="fs-14 lh-22 mb-2">
                Easy Learning is required by law to collect applicable transaction taxes for purchases made in certain tax jurisdictions.
            </p>
            <p class="fs-14 lh-22 mb-3">
                By completing your purchase you agree to these
                <a href="#" class="text-color hover-underline">Terms of Service.</a></p>
