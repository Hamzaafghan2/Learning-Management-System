...
<header class="header-menu-area">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="logo-box logo--box">
                            <a href="index.html" class="logo"><img src="{{asset('frontend/images/logo2.png')}}" alt="logo"></a>
 ...
 @endphp
                        ...
                        <ul class="generic-list-item">
                            ...
                            <li>
                                <a href="#" class="position-relative">
                                    <span class="fs-17 font-weight-semi-bold d-block">Easy Learning for Business</span>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled main-off-canvas-menu">
        ...
        <h4 class="off-canvas-menu-heading pt-20px">More from Easy Learning</h4>
        <ul class="generic-list-item off-canvas-menu-list pt-1">
            <li><a href="for-business.html">Easy Learning for Business</a></li>
