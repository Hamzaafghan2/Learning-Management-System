    ...
    <div class="container">
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                ...
                Joined {{ Carbon\Carbon::parse($instructor->created_at)->diffForHumans() }}
            </span>
            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-2 fs-35">351</h4>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-3 fs-35">351</h4>
    ...
    <div class="bg-gray py-5">
        <div class="container">
            <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                ...
                <div id="chat-app">
                <App 
                    :recevierid="{{ $instructor->id }}" 
                    receviername="{{ $instructor->name }}"
                />
             </div>
                </li>
                @else
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
                    <div class="card-image">
                        <a href="course-details.html" class="d-block">
                            ...
                            src="{{asset($course->course_image)}}" data-src="{{asset($course->course_image)}}" alt="Card image cap">
                        </a>
